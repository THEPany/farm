...
return [
    ...
    */
    ...
    'dashboard' => [
        ...
        'widgets' => [
            App\Widgets\AnimalDimmer::class,
            App\Widgets\FoodDimmer::class,
            App\Widgets\VaccinationDimmer::class,
            App\Widgets\MaternityDimmer::class,
            App\Widgets\DevelopDimmer::class,
            App\Widgets\GrowthDimmer::class,
            App\Widgets\ReadyDimmer::class,
        ],
